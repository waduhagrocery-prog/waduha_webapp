...
const TILES = [
  ...
  { key: "snacks",         label: "Snacks & Chocolate", photo: u("photo-1548907040-4baa42d10919"),    to: "/products?cat=snacks" },
  ...
  { key: "breakfast",      label: "Breakfast Food",     photo: u("photo-1533089860892-a7c6f0a88666"),    to: "/products?q=cereal" },
  { key: "coffee_tea",     label: "Coffee & Tea",       photo: u("photo-1495474472287-4d71bcdd2085"),    to: "/products?q=coffee" },
  { key: "world_foods",    label: "World Foods",        photo: u("photo-1565958011703-44f9829ba187"),    to: "/products?q=biryani" },
  { key: "condiments",     label: "Condiments & Sauces",photo: u("photo-1472476443507-c7a5948772fc"),    to: "/products?q=ketchup" },
  ...
  { key: "personal_care",  label: "Personal Care",      photo: u("photo-1556228852-80b6e5eeff06"),    to: "/coming-soon?d=personal_care", soon: true },
  { key: "beauty",         label: "Beauty & Fragrance", photo: u("photo-1556228720-195a672e8a03"),    to: "/coming-soon?d=beauty", soon: true },
  { key: "baby",           label: "Baby & Kids",        photo: u("photo-1519689680058-324335c77eba"),    to: "/coming-soon?d=baby", soon: true },
